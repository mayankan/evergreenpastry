		...
		<div class="top">
			...
			<div class="zerogrid">
				<ul class="number f-left">
					<a href="mailto:mail@evergreenpastry.com">
						<li class="mail">
							<p>mail@evergreenpastry.com</p>
						</li>
					</a>
					<li class="phone">
						<p>(+91) 9810437677</p>
								...
								<div class="contact">
									<div id="contact_form">
										<form name="contact" id="contact" method="post" action="reservation.php">
											...
											<label class="row">
												<div class="wrap-col">
													<textarea name="message" id="message" class="form-control" rows="4" cols="25" required="required" placeholder="Order"></textarea>
												</div>
											</label>
